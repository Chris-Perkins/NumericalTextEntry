...
open class UINumberEntryField: UIControl {
    ...
    /// The maximum number of components in a decimal number when split by the decimal separator.
    //// The answer is two since X.Y split by "." has 2 components. There are no X.Y.Z numbers.
